...
class Ui_WindowLogin(object):
    def setupUi(self, WindowLogin):
        ...
        WindowLogin.resize(1280, 720)
        WindowLogin.setMinimumSize(QtCore.QSize(1280, 720))
        WindowLogin.setMaximumSize(QtCore.QSize(1280, 720))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(14)
        WindowLogin.setFont(font)
        WindowLogin.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
...
"}")
        ...
        self.label_autor_text.setGeometry(QtCore.QRect(820, 649, 361, 41))
        font = QtGui.QFont()
        ...
        self.lable_suppot_text.setGeometry(QtCore.QRect(830, 590, 341, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
