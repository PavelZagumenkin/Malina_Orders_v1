...
class Ui_WindowPie(object):
    def setupUi(self, WindowPie):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=WindowPie)
        self.centralwidget.setEnabled(True)
        self.centralwidget.setObjectName("centralwidget")
        self.lineEdit_OLAP_dayWeek_pie = QtWidgets.QLineEdit(parent=self.centralwidget)
...
"}")
        ...
        self.label_OLAP_dayWeek_pie = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.btn_exit_pie = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_path_dayWeek_pie = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.label_select_konditerskoi = QtWidgets.QLabel(parent=self.centralwidget)
...
"}")
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(830, 50, 381, 472))
        ...
        self.cb_svoboda_2 = QtWidgets.QCheckBox(parent=self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.cb_svoboda_2.setFont(font)
        self.cb_svoboda_2.setChecked(True)
        self.cb_svoboda_2.setObjectName("cb_svoboda_2")
        self.gridPoints.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cb_svoboda_2)
        ...
        self.gridPoints.setWidget(8, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cb_moskovskaya)
        ...
        self.btn_download_plans = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.progressBar.setGeometry(QtCore.QRect(330, 330, 600, 40))
        ...
        self.label_prioritet = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.btn_prioritet = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
    ...
    def retranslateUi(self, WindowPie):
        ...
        self.cb_astrahanskaya.setText(_translate("WindowPie", "Астраханская"))
        self.cb_svoboda_2.setText(_translate("WindowPie", "Радищева"))
        self.cb_volsk.setText(_translate("WindowPie", "Вольск"))
        self.cb_rahova.setText(_translate("WindowPie", "Рахова"))
        self.cb_gorpark.setText(_translate("WindowPie", "ГорПарк"))
        ...
        self.cb_orgevskogo.setText(_translate("WindowPie", "Оржевского"))
        ...
        self.cb_centr.setText(_translate("WindowPie", "Центр"))
