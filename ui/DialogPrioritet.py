...
class Ui_DialogPrioritet(object):
    def setupUi(self, DialogPrioritet):
        ...
        DialogPrioritet.resize(370, 540)
        DialogPrioritet.setMinimumSize(QtCore.QSize(370, 540))
        DialogPrioritet.setMaximumSize(QtCore.QSize(370, 540))
        self.formLayoutWidget = QtWidgets.QWidget(DialogPrioritet)
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 70, 351, 401))
        ...
        self.btn_save.setGeometry(QtCore.QRect(10, 480, 351, 51))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
...
"}")
    ...
    def retranslateUi(self, DialogPrioritet):
        ...
        self.cb_rokot.setText(_translate("DialogPrioritet", "Рокот"))
        ...
        self.cb_tarhova.setText(_translate("DialogPrioritet", "Тархова"))
        self.cb_madonna.setText(_translate("DialogPrioritet", "Мадонна"))
        ...
        self.cb_pavilon.setText(_translate("DialogPrioritet", "ПП(павильон)"))
