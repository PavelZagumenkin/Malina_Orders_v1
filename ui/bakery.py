...
class Ui_WindowBakery(object):
    def setupUi(self, WindowBakery):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=WindowBakery)
        self.centralwidget.setEnabled(True)
        self.centralwidget.setObjectName("centralwidget")
        self.lineEdit_OLAP_dayWeek_bakery = QtWidgets.QLineEdit(parent=self.centralwidget)
        ...
        self.label_OLAP_P = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.lineEdit_OLAP_P = QtWidgets.QLineEdit(parent=self.centralwidget)
        ...
        self.btn_path_OLAP_P = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.label_settings_title = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.label_OLAP_dayWeek_bakery = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.btn_exit_bakery = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_path_dayWeek_bakery = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_koeff_Prognoz = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.label_startDay_and_endDay = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.label_startDay = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.label_EndDay = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.dateEdit_EndDay = QtWidgets.QDateEdit(parent=self.centralwidget)
        ...
        self.btn_prosmotrPrognoz = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_editPrognoz = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_editNormativ = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_Normativ = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_edit_koeff_DayWeek = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_download_Normativ = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.label_OLAP_P_2 = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.btn_prosmotr_koeff_DayWeek = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_deletePrognoz = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_delete_koeff_DayWeek = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.btn_koeff_DayWeek = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.cb_gorpark.setChecked(True)
        ...
        self.cb_astrahanskaya = QtWidgets.QCheckBox(parent=self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.cb_astrahanskaya.setFont(font)
        self.cb_astrahanskaya.setChecked(True)
        self.cb_astrahanskaya.setObjectName("cb_astrahanskaya")
        self.gridPoints.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cb_astrahanskaya)
        ...
        self.gridPoints.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cb_rahova)
        self.cb_radisheva = QtWidgets.QCheckBox(parent=self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.cb_radisheva.setFont(font)
        self.cb_radisheva.setChecked(True)
        self.cb_radisheva.setObjectName("cb_radisheva")
        self.gridPoints.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cb_radisheva)
        ...
        self.cb_orgevskogo.setChecked(True)
        ...
        self.btn_deleteNormativ = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.label_OLAP_P_3 = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.btn_download_Layout = QtWidgets.QPushButton(parent=self.centralwidget)
...
"}")
        ...
        self.progressBar.setGeometry(QtCore.QRect(350, 340, 600, 40))
    ...
    def retranslateUi(self, WindowBakery):
        ...
        self.cb_gorpark.setText(_translate("WindowBakery", "ГорПарк"))
        self.cb_volsk.setText(_translate("WindowBakery", "Вольск"))
        self.cb_astrahanskaya.setText(_translate("WindowBakery", "Астраханская"))
        ...
        self.cb_radisheva.setText(_translate("WindowBakery", "Радищева"))
        self.cb_pobeda.setText(_translate("WindowBakery", "Победа"))
        self.cb_orgevskogo.setText(_translate("WindowBakery", "Оржевского"))
        self.cb_entuziastov.setText(_translate("WindowBakery", "Энтузиастов"))
        self.cb_centr.setText(_translate("WindowBakery", "Центр"))
