...
"}")
        ...
        self.gridPoints.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cb_marks)
        ...
        self.gridPoints.setWidget(9, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cb_orang)
        ...
        self.cb_radisheva = QtWidgets.QCheckBox(self.formLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.cb_radisheva.setFont(font)
        self.cb_radisheva.setChecked(True)
        self.cb_radisheva.setObjectName("cb_radisheva")
        self.gridPoints.setWidget(11, QtWidgets.QFormLayout.ItemRole.LabelRole, self.cb_radisheva)
        ...
        self.gridPoints.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.cb_entuziastov)
