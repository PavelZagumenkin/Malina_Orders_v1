...
class Ui_WindowMain(object):
    def setupUi(self, WindowMain):
        ...
        WindowMain.setMinimumSize(QtCore.QSize(1280, 720))
        WindowMain.setMaximumSize(QtCore.QSize(1280, 720))
        font = QtGui.QFont()
        font.setFamily("Trebuchet MS")
        font.setPointSize(14)
        WindowMain.setFont(font)
        WindowMain.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        WindowMain.setMouseTracking(False)
        WindowMain.setTabletTracking(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("image/icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        WindowMain.setWindowIcon(icon)
        WindowMain.setStyleSheet("background: #fff")
...
"}")
        ...
        WindowMain.setTabOrder(self.line_login, self.line_password)
        WindowMain.setTabOrder(self.line_password, self.btn_login)
        WindowMain.setTabOrder(self.btn_login, self.btn_path_OLAP_P)
        WindowMain.setTabOrder(self.btn_path_OLAP_P, self.btn_path_ost_cakes)
        WindowMain.setTabOrder(self.btn_path_ost_cakes, self.btn_pie)
        WindowMain.setTabOrder(self.btn_pie, self.btn_cakes)
        WindowMain.setTabOrder(self.btn_cakes, self.btn_others)
        WindowMain.setTabOrder(self.btn_others, self.btn_bakery)
        WindowMain.setTabOrder(self.btn_bakery, self.btn_filling)
        WindowMain.setTabOrder(self.btn_filling, self.btn_path_dayWeek_pie)
        WindowMain.setTabOrder(self.btn_path_dayWeek_pie, self.btn_path_dayWeek_cakes)
        WindowMain.setTabOrder(self.btn_path_dayWeek_cakes, self.btn_path_ost_filling)
        WindowMain.setTabOrder(self.btn_path_ost_filling, self.btn_exit)
        WindowMain.setTabOrder(self.btn_exit, self.btn_path_dayWeek_bakery)

    def retranslateUi(self, WindowMain):
        _translate = QtCore.QCoreApplication.translate
        WindowMain.setWindowTitle(_translate("WindowMain", "Малина 64"))
        self.autor_text.setText(_translate("WindowMain", "Автор логиcтических расчетов Китов А.О. \n"
" Разработчик Загуменкин П.И."))
        self.suppot_text.setText(_translate("WindowMain", "По всем вопросам работы программы \n"
" обращаться в Отдел построения"))
        self.btn_login.setText(_translate("WindowMain", "Начать работу"))
        self.btn_login.setShortcut(_translate("WindowMain", "Return"))
        self.line_password.setPlaceholderText(_translate("WindowMain", "Пароль"))
        self.line_login.setPlaceholderText(_translate("WindowMain", "Логин"))
        self.label_login_password.setText(_translate("WindowMain", "Введите логин и пароль"))
        self.label_settings_title.setText(_translate("WindowMain", "Настройка подключения внешних данных"))
        self.label_OLAP_P.setText(_translate("WindowMain", "Укажите путь к OLAP отчету по продажам"))
        self.btn_path_OLAP_P.setText(_translate("WindowMain", "..."))
        self.btn_path_dayWeek_bakery.setText(_translate("WindowMain", "..."))
        self.label_OLAP_dayWeek_bakery.setText(_translate("WindowMain", "Укажите путь к OLAP отчету по продажам по дням недели - выпечка"))
        self.btn_path_ost_cakes.setText(_translate("WindowMain", "..."))
        self.label_ost_cakes.setText(_translate("WindowMain", "Укажите путь к Остаткам по складам - торты"))
        self.btn_pie.setText(_translate("WindowMain", "ПИРОЖНЫЕ"))
        self.btn_cakes.setText(_translate("WindowMain", "ТОРТЫ"))
        self.btn_others.setText(_translate("WindowMain", "ОСТАЛЬНОЕ"))
        self.btn_bakery.setText(_translate("WindowMain", "ВЫПЕЧКА"))
        self.btn_filling.setText(_translate("WindowMain", "НАЧИНКИ"))
        self.btn_path_dayWeek_pie.setText(_translate("WindowMain", "..."))
        self.label_OLAP_dayWeek_pie.setText(_translate("WindowMain", "Укажите путь к OLAP отчету по продажам по дням недели - пирожные"))
        self.btn_path_dayWeek_cakes.setText(_translate("WindowMain", "..."))
        self.label_OLAP_dayWeek_cakes.setText(_translate("WindowMain", "Укажите путь к OLAP отчету по продажам по дням недели - торты"))
        self.btn_path_ost_filling.setText(_translate("WindowMain", "..."))
        self.label_ost_filling.setText(_translate("WindowMain", "Укажите путь к Остаткам по складам - начинка"))
        self.btn_exit.setText(_translate("WindowMain", "ВЫХОД"))
